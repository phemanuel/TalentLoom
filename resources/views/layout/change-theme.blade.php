                                ...
                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                    ...
                                    <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Change Theme</li>
<li class="breadcrumb-item active text-primary" aria-current="page"><a href="{{route('user-message')}}">Message</a></li>

                                                <li class="breadcrumb-item active text-primary" aria-current="page"><a href="{{route('user-about')}}">About</a></li>
          ...
          @elseif(session('error'))
						...
						@endif
                                    ...
                                    <table class="table-bordered">
                                        ...
                                        data-placement="top" title="Activate">Activate</a>
                                        </p><hr>
                                        <p>
                                            <a class="badge mb-0 badge-primary style2" href="{{ route('preview-theme', ['id' => auth()->user()->id, 'theme' => $rs->theme]) }}" 
                                        data-placement="top" title="Preview" target="_blank">Preview</a>
