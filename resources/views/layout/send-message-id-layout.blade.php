                                                ...
                                                <div class="app-chat-sidebar border-right border-md-n h-100">
                                                    ...
                                                    <div class="app-chat-sidebar-user-item">
                                                                @if($currentUser->count() == 0)
                                                                    <p align="center"> User unavailable.</p>
                                                                @else                                                                   
                                                                        
                                                                            <a href="javascript:void(0)">
                                                                                <div class="d-flex">
                                                                                    <div class="bg-img">
                                                                                        <img class="img-fluid" src="{{ asset('storage/app/public/' . $currentUser->user_picture) }}" alt="user">
                                                                                        <i class="bg-img-status bg-danger"></i>
                                                                                    </div>
                                                                                    <div>
                                                                                        <h5 class="mb-0">{{$currentUser->full_name}}</h5>
                                                                                        <p><span><i class="zmdi zmdi-check-all mr-2"></i></span>{{$currentUser->user_type}}</p>
                                                ...
                                                <div class="app-chat-msg">
                                                    <div class="d-flex align-items-center justify-content-between p-3 px-4 border-bottom">
                                                        <div class="app-chat-msg-title">
                                                            ...
                                                            <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                            <li class="breadcrumb-item active text-primary" aria-current="page"><a href="#">{{auth()->user()->full_name}}</a></li>
                                                 <li class="breadcrumb-item text-primary" aria-current="page"><a href="#">{{$currentUser->full_name}}</a></li>
                                                 </ol>
                                        </nav>
                                                </div>
                                               ...
                                               <form action="{{route('send-message-action')}}" method="post"><div class="app-chat-type">
                                                @csrf
                                                ...
                                                <input type="hidden" name="to_user_id" value="{{$currentUser->id}}">
                                                <input type="hidden" name="from_user_email" value="{{auth()->user()->email}}">
                                                <input type="hidden" name="to_user_email" value="{{$currentUser->email}}">
                                                <input type="hidden" name="from_user_fullname" value="{{auth()->user()->full_name}}">
                                                <input type="hidden" name="to_user_fullname" value="{{$currentUser->full_name}}">
                                                <input type="hidden" name="from_user_type" value="{{auth()->user()->user_type}}">
                                                <input type="hidden" name="to_user_type" value="{{$currentUser->user_type}}">
                                                <input type="hidden" name="from_user_picture" value="{{auth()->user()->user_picture}}">
                                                <input type="hidden" name="to_user_picture" value="{{$currentUser->user_picture}}">
