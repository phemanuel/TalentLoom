				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="{{route('home')}}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="#"> Sign Up</a></p>
						</div>											
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="submit-left">
								<h4>Sign up as a Freelancer</h4>
								<p>
									Create an account now, to give you access to jobs and upskill opportunities.
								</p>
								<a href="{{route('signup-freelancer')}}" class="primary-btn header-btn">Sign up</a>	
							</div>
						</div>
						<div class="col-lg-6 ">
							<div class="submit-right">
								...
								<p>
									Create an account now, to start posting jobs, and find the best candidate for your job.
								</p>
								<a href="{{route('signup-organization')}}" class="primary-btn header-btn">Sign up</a>		
							</div>			
						</div>
