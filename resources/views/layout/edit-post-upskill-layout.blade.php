                                        ...
                                        <div class="tab nav-center">
                                            ...
                                            <div class="tab-content" id="v-pills-tabContent">
                                                ...
                                                <div class="page-account-form">
                                                    ...
                                                    <div class="p-4">
                                                        <form name="asic-form" action="{{ route('update-upskill', ['id' => $postUpskill->id]) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf	
                                                        @method('PUT')													
                                                        <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Company Name</span></label>
                                                                    <input type="text" class="form-control" name="company_name" placeholder="Lotan Consult" value="{{$postUpskill->company_name}}"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <table>
                                                                        <tr>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" name="upskill_name" placeholder="Social Media Manager" value="{{$postUpskill->upskill_name}}"  style="color: black;">
                                                                </div>
                                                                <div class="form-group">
                                                                <label for="add1"><span class="style1">Upskill Description</span></label>
                                                                <textarea id="editor1" name="upskill_description" rows="10" cols="50"  required>{{$postUpskill->upskill_description}}</textarea>
                                                            </div>                                                             
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Upskill Category</span></label>
                                                                    <select name="upskill_category" class="form-control">
                                                                        <option value="{{$postUpskill->upskill_category}}">{{$postUpskill->upskill_category}}</option>
    ...
    @endif
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                 <label for="name1"><span class="style1">Upskill Status</span></label>
                                                                    ...
                                                                    <option value="{{$postUpskill->upskill_status}}">{{$postUpskill->upskill_status}}</option>
                                                            ...
                                                            <button type="submit" class="btn btn-primary">Update Upskill</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
