                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        ...
                        <li class="nav-static-title">Dashboard</li>
                            ...
                            <li class="active"><a href="{{ route('user-role-organization') }}" aria-expanded="false"><i class="nav-icon ti ti-info"></i><span class="nav-title">Industry Sector</span></a> </li>
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-xl-5 col-md-6 col-12 border-t border-right">
                                                <div class="page-account-form">
                                                    ...
                                                    @endif                                                 
                                                        <h5 class="mb-0 py-2">Add and Edit Industry Sector</h5>
                                                    </div>
                                                    <div class="p-4">
                                                        <form name="asic-form" action="{{ route('user-org-role-save', ['id' => auth()->user()->id]) }}" method="POST">
                                                        @csrf
														@method('PUT')
                                                        <!-- start selects row -->
                                        ...
                                        <div class="card card-statistics Multi-sel">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    ...
                                                    <p class="style1">You can only select maximum of 3 sectors.</p>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="form-group mb-0">
                                                <select class="js-basic-multiple form-control" name="user_sectors[]" multiple="multiple" onchange="limitRolesSelection(this)>
                                                    @foreach($allRoles as $role)
                                                        <option value="{{ $role->category }}" 
                                                            {{ in_array($role->category, $userRoles) ? 'selected' : '' }}>
                                                            {{ $role->category }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <script>
document.querySelector('select[name="user_sectors[]"]').addEventListener('change', function() {
    var selectedOptions = this.selectedOptions;
    if (selectedOptions.length > 6) {
        alert("You can select up to 3 sectors.");
