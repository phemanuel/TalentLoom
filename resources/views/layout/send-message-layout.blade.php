                                            ...
                                            <div class="col-xl-4 col-xxl-3">
                                                <div class="app-chat-sidebar border-right border-md-n h-100">
                                                    ...
                                                    <div class="app-chat-sidebar-user-item">
                                                                @if($allFreelancers->count() == 0)
                                                                    <p align="center"> Users unavailable.</p>
                                                                @else
                                                                    @foreach($allFreelancers as $allFreelancer)
                                                                        @if($allFreelancer->id != auth()->user()->id)
                                                                            <a href="{{route('send-message-id', ['id' => $allFreelancer->id])}}">
                                                                                <div class="d-flex">
                                                                                    <div class="bg-img">
                                                                                        <img class="img-fluid" src="{{ asset('storage/app/public/' . $allFreelancer->user_picture) }}" alt="user">
                                                                                        <i class="bg-img-status bg-danger"></i>
                                                                                    </div>
                                                                                    <div>
                                                                                        <h5 class="mb-0">{{$allFreelancer->full_name}}</h5>
                                                                                        <p><span><i class="zmdi zmdi-check-all mr-2"></i></span>{{$allFreelancer->user_type}}</p>
                                                        ...
                                                        @if($allOrganization->id != auth()->user()->id)
                                                            <a href="{{route('send-message-id', ['id' => $allOrganization->id])}}">
                                                                <div class="d-flex">
                                                                    <div class="bg-img">
                                                                        <img class="img-fluid" src="{{ asset('storage/app/public/' . $allOrganization->user_picture) }}" alt="user">
                                                                        <i class="bg-img-status bg-danger"></i>
                                                                    </div>
                                                                    <div>
                                                                        <h5 class="mb-0">{{$allOrganization->full_name}}</h5>
                                                                        <p><span><i class="zmdi zmdi-check-all mr-2"></i></span>{{$allOrganization->user_type}}</p>
