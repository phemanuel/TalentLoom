            ...
            <div class="input-boxes">
              <div class="input-box">
                ...
                @error('password')
									<span class="invalid-feedback">{{ $message }}</span>
									@enderror
              <div align= "left" class="text"><a href="{{ route('password.request') }}">Forgot password?</a></div>
              <div align="right" class="text"><input type="checkbox" name="checkbox" id="checkbox" />Show password</div>
