				...
				<div class="container">
					<div class="row justify-content-center d-flex">
						<div class="col-lg-8 post-list">
                            ...
                            <div class="single-post d-flex flex-row">
								...
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">											
											<strong><h4>No upskill posted yet, check back later</h4></strong>					
										</div>
										<ul class="btns">
                            ...
                            @else
                            @foreach($postUpskill as $upskill)
                            <div class="single-post d-flex flex-row">
								<div class="thumb">
                                <img src="{{ asset('storage/app/public/' . $upskill->company_logo) }}" alt="Company Logo" width="60" height="60">
									
								</div>
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href=""><h4>{{$upskill->upskill_name}}</h4></a>
											<h6 class="style1">{{$upskill->upskill_category}} || <i>Posted {{ $upskill->created_at->diffForHumans() }}</i> </h6>					
									  </div>                                        
									</div>
                                    <hr>	
									<ul class="btns">                             
											<li><a href="{{route('view-upskill', ['id' => $upskill->id])}}">View Details</a></li>                                            
										</ul>
								</div>
							</div>
                            @endforeach
							...
							<h4>Job Opportunities</h4>
								...
								<div class="active-relatedjob-carusel">									
									...
									<div class="single-rated">
										<img class="img-fluid" src="{{ asset('storage/app/public/' . $job->company_logo) }}" alt="" width="100" height="50">
										<a href="#"><h4>{{$job->job_name}}</h4></a>
										<h6>Created by : {{$job->company_name}}</h6>										
										<a href="{{route('view-job', ['id' => $job->id])}}" class="btns text-uppercase">View Details</a>
									</div>	
									@endforeach																								
								</div>
								@else									
									<p>Job opportunities not available at the moment, check back later.</p>
									@endif
							</div>												
